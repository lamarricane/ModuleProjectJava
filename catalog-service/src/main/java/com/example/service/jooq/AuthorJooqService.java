...
@Service
public class AuthorJooqService {
    private static final Logger logger = LoggerFactory.getLogger(AuthorJooqService.class);
    private final AuthorJooqRepository authorRepository;

    public AuthorJooqService(AuthorJooqRepository authorRepository) {
